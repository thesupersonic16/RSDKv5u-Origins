...
extern "C" __declspec(dllexport) void Init(ModInfo *modInfo)
{
    ...
    WRITE_MEMORY(SigProcessEngine_0A(), 0x48, 0x83, 0xC4, 0x28, 0xC3);
    WRITE_MEMORY(SigRunCore_0A(), 0xC3);

    // Don't use AVX
    WRITE_MEMORY(((char *)SigAVXPatch() + 0x00), 0xF3, 0x0F);
    WRITE_MEMORY(((char *)SigAVXPatch() + 0x08), 0xF3, 0x0F);
    WRITE_MEMORY(((char *)SigAVXPatch() + 0x20), 0xF3, 0x0F);
    WRITE_MEMORY(((char *)SigAVXPatch() + 0x28), 0xF3, 0x0F);
    WRITE_MEMORY(((char *)SigAVXPatch() + 0x40), 0xF3, 0x0F);
    WRITE_MEMORY(((char *)SigAVXPatch() + 0x48), 0xF3, 0x0F);
    WRITE_MEMORY(((char *)SigAVXPatch() + 0x60), 0xF3, 0x0F);
    WRITE_MEMORY(((char *)SigAVXPatch() + 0x68), 0xF3, 0x0F);
    WRITE_MEMORY(((char *)SigAVXPatch() + 0x85), 0x66, 0x0F, 0x7E, 0xC0, 0xF3, 0x0F);
