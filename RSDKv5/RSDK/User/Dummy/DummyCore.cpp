...
int32 GetAPIValue(uint32 id)
{
    switch (id) {
        ...
        case 0x4205582D: return 0; // SYSTEM_LEADERBOARD_LOAD_TIME
        ...
        case 0xBDF4E94A: return 0; // SYSTEM_USERSTORAGE_AUTH_TIME

        case 0xD77E98BE: return 0; // SYSTEM_USERSTORAGE_STORAGE_INIT_TIME

        case 0x5AF715C2: return 0; // SYSTEM_USERSTORAGE_STORAGE_LOAD_TIME

        case 0x54378EC5: return 0; // SYSTEM_USERSTORAGE_STORAGE_SAVE_TIME

        case 0xCD44607D: return 0; // SYSTEM_USERSTORAGE_STORAGE_DELETE_TIME
    }
