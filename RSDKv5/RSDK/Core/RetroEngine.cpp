...
void RSDK::NotifyCallback(int32 callback, int32 param1, int32 param2, int32 param3)
{
    ...
    switch (callback) {
        ...
        case NOTIFY_STATS_MOVIE:
            PrintLog(PRINT_NORMAL, "NOTIFY: StatsMovie()");
        ...
        // Origins callbacks
        case NOTIFY_UNKNOWN1001: PrintLog(PRINT_NORMAL, "NOTIFY: Unknown1001() -> %d, %d, %d", param1, param2, param3); break;
        case NOTIFY_UNKNOWN1002: PrintLog(PRINT_NORMAL, "NOTIFY: Unknown1002() -> %d, %d, %d", param1, param2, param3); break;
        case NOTIFY_UNKNOWN1003: PrintLog(PRINT_NORMAL, "NOTIFY: Unknown1003() -> %d, %d, %d", param1, param2, param3); break;
        case NOTIFY_UNKNOWN1004: PrintLog(PRINT_NORMAL, "NOTIFY: Unknown1004() -> %d, %d, %d", param1, param2, param3); break;
        case NOTIFY_UNKNOWN1005: PrintLog(PRINT_NORMAL, "NOTIFY: Unknown1005() -> %d, %d, %d", param1, param2, param3); break;
        case NOTIFY_UNKNOWN1006: PrintLog(PRINT_NORMAL, "NOTIFY: Unknown1006() -> %d, %d, %d", param1, param2, param3); break;
        case NOTIFY_UNKNOWN1007: PrintLog(PRINT_NORMAL, "NOTIFY: Unknown1007() -> %d, %d, %d", param1, param2, param3); break;
